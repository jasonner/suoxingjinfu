(function(){
        ...
        H5lock.prototype.storePass = function(psw) {// touchend结束之后对密码和状态的处理
            if (this.pswObj.step == 1) {
                ...
                if (this.checkPass(this.pswObj.spassword, psw)) {
                    ...
                    this.drawStatusPoint('#3693e0');
                    window.location.href="../index.html";
                } else {
                    document.getElementById('title').innerHTML = '解锁失败';
                    this.drawStatusPoint('#e43637');
                }
            } else {
                this.pswObj.step = 1;
        ...
        H5lock.prototype.initDom = function(){
            ...
            var str = '<h4 id="title" class="title">请输入手势密码</h4>'+
                      '<a id="updatePassword" style="position: absolute;right: 5px;top: 5px;color:red;font-size: 10px;display:none;">重置密码</a>'+
                      '<canvas id="canvas" width="300" height="500" style="background-color: #fff;display: block;margin：0 auto;"></canvas>';
            wrap.innerHTML = str;
